...
public class AgendaEventos {
    ...
    public static void main(String[] args) {
        ...
        agendaEventos.adicionarEventos(LocalDate.of(2024, Month.JULY, 15), "Evento 1", "Atracao 1");
        agendaEventos.adicionarEventos(LocalDate.of(2024, Month.AUGUST, 20), "Evento 2", "Atracao 2");
        agendaEventos.adicionarEventos(LocalDate.of(2024, Month.SEPTEMBER, 04), "Evento 3", "Atracao 3");
